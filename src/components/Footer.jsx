  ...
  return (
    ...
    <div className="h-full bg-darkBlue grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-10">
        <div className='p-11'>
            ...
            <p className="bg-mediumBlue text-white rounded-full italic font-bold w-52 py-2 px-4"><span>M </span>info@tryös.com</p>
        </div>
        ...
        <p className='text-center bg-darkBlue text-white text-sm font-medium pb-4'> © 2023. All Rights Reserved.</p>
    </>
  )
}
