    ...
    <>
      <div className="h-full bg-darkBlue grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-10">
        <div className="p-11">
          ...
          <p className="bg-mediumBlue text-white rounded-full italic font-bold w-52 py-2 px-4 mb-3">
            <span>P </span>+90 555 333 55 33
          </p>
          <p className="bg-mediumBlue text-white rounded-full italic font-bold w-52 py-2 px-4">
        ...
        <div className="p-11">
          ...
          <p className="pb-2">
            <a className="text-rose text-sm font-medium" href="#">
              About Us
            </a>
          </p>
          <p className="pb-2">
        ...
        <div className="p-11 ">
          ...
          <p className="pb-2">
            <a className="text-rose pb-2 text-sm font-medium" href="#">
              My Profile
            </a>
          </p>
          <p className="pb-2">
